...
int main(){
    ...
    printf("Test 1: Two treaure cards on top of deck\n");
    printf("========================================\n");
    ...
    gs = gsOrig;
    printf("Test 2: 1 non treaure card on top of deck, then 2 treasure cards\n");
    printf("========================================\n");
    //add a duchy
    ...
    gs = gsOrig;
    printf("Test 3: One treaure card on top of deck, then 20 non treasure cards, then treasure card\n");
    printf("========================================\n");
    //add a copper
    gs.deck[0][gs.deckCount[0]++] = copper;
    //add 20 duchy
